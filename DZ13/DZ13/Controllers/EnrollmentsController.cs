...
namespace DZ13.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(DZ13Context context)
        {
            _context = context;
        }
        ...
        {
            var dZ13Context = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
            return View(await dZ13Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentId,CourseId,EnrollmentDate,Grade,Status")] Enrollment enrollment)
        {
            ...
            ViewData["CourseId"] = new SelectList(_context.Courses, "Id", "CourseCode", enrollment.CourseId);
